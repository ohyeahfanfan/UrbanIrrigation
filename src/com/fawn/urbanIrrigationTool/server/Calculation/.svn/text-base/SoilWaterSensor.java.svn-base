...
public class SoilWaterSensor extends Hydrology{
	...
	public void calculateOneRound(float[] input, float[] output, int roundNum){
	    ...
	    if(input[I]!=0){
		    if(output[SWCcur] > input[FC] * input[RD] * input[TH]){
		    	input[I] = 0;
		    }
	    }
	...
	public static void main(String[] args) {
		SoilWaterSensor h = new SoilWaterSensor();
